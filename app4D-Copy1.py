...
if st.button('点击进行预测 Click here'):
    ...
    try:
        ...
        st.write(f"您目前的 FEV1/FVC 预测值是 Your predicted value of FEV1/FVC: <span style='font-size: 20px;'><strong>**{fev1_fvc_score}**")
        st.write(f"您目前的 FEV1%pred 预测值是 Your predicted value of FEV1/FVC:<span style='font-size: 20px;'><strong> **{fev1_pred_score}**")
        st.write(f"您目前的 GOLDCOPD 预测值是 Your predicted label of GOLDCOPD: <span style='font-size: 20px;'><strong>**{GOLDCOPD_score}**")
